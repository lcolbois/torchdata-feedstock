...
Once the `conda-forge` channel has been enabled, `torchdata` can be installed with:

```
conda install torchdata
```

It is possible to list all of the versions of `torchdata` available on your platform with:
